"""Run the observational Phase 7.1 Stage 1 exit-efficiency diagnosis."""
...
def main() -> int:
    ...
    parser.add_argument(
        "--output", type=Path,
        default=Path("exports/phase7_1/phase71_exit_efficiency.json"),
    )
    ...
    write_exit_efficiency_report(
        exit_efficiency_report(bundle), args.output, overwrite=args.overwrite,
    )
    return 0
